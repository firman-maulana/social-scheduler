...
const Dashboard = () => {
    ...
    return (
        <div className="space-y-8">
            {/* Welcome bar */}
            <div>
              <h2 className="text-2xl text-slate-900">Good Morning, Firman!</h2>
            ...
            <div className='bg-white rounded-2xl border border-slate-200 overflow-hidden'>
              ...
              {activities.length === 0 ? (
                <div className='flex flex-col items-center justify-center py-16 px-6'>
                  ...
                  <p className='text-slate-400 text-sm mt-1'>Connect accounts and shedule posts to see events here.</p>
                </div>
              ) : (
